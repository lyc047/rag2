...
const messages = {
  'zh-CN': {
    ...
    aboutVersion: '版本 2.0.0',
    confirmDeleteSession: '删除后不可恢复，确定要删除该会话吗？',
    deleteAllSessions: '删除全部会话',
    confirmDeleteAllSessions: '将删除所有历史会话，此操作不可恢复。确定继续吗？',
    deletedAllSessions: '已删除全部会话',
    edit: '编辑',
    done: '完成',
    selectAll: '全选',
    deselectAll: '取消全选',
    ...
    deleteNote: '删除笔记',
    confirmDeleteNote: '删除后不可恢复，确定删除该笔记吗？',
  ...
  'en': {
    ...
    confirmDeleteAllSessions: 'This will delete all chat history. This cannot be undone. Continue?',
    deletedAllSessions: 'All sessions deleted',
    edit: 'Edit',
    done: 'Done',
    ...
    confirmDeleteNote: 'This cannot be undone. Delete this note?',
